      ...
      <footer className="bg-gray-50 border-t border-gray-300 py-6 block md:hidden">
        <div className="max-w-xs mx-auto flex flex-col items-center gap-3">
          ...
          <div className="flex items-center gap-2 justify-center mt-2">
            ...
            <a href="https://wa.me/5515991047579" target="_blank" rel="noopener noreferrer" className="p-2 bg-white rounded-lg shadow text-slate-700 text-xl hover:shadow-md transition">
