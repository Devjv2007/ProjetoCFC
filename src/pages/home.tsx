...
export default function CFCGrupoG6() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center gap-4 relative">
            ...
            {/* Menu mobile absoluto colado na header */}
           <div
            id="mobile-menu"
            className={[
              "fixed left-0 right-0 top-20 z-50 md:hidden", // top-20 faz o menu começar abaixo da header
      ...
      <section id="inicio" className="relative min-h-[640px] md:min-h-[720px] overflow-hidden">
        ...
        <section id="cursos" className="scroll-mt-24 md:scroll-mt-28 py-16 md:py-20 bg-white">
    <div className="container mx-auto px-4">
      ...
      {/* Serviços */}
      <section id="servicos" className="scroll-mt-24 md:scroll-mt-28 py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-7xl">
      ...
      {/* Depoimentos */}
      <section id="depoimentos" className="scroll-mt-24 md:scroll-mt-28 py-16 md:py-20">
  <div className="container mx-auto px-4">
    <div className="mx-auto max-w-7xl">
      ...
      {/* Por que escolher */}
    <section id="porque" className="scroll-mt-24 md:scroll-mt-28 py-16 md:py-2">
  <div className="container mx-auto px-4">
    <div className="mx-auto max-w-7xl text-center mb-10 md:mb-14">
      <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900">
        Por Que Escolher o 
     <span className="text-3xl md:text-5xl font-extrabold text-blue-700"> CFC Grupo G6?</span></h2>
  ...
  <article className="rounded-2xl border border-slate-200 bg-white p-6 md:p-7 shadow-sm hover:shadow-md transition">
    ...
    <p className="mt-1.5 text-sm text-slate-600">
      ...
      {/* CTA */}
      <section id="contato" className="scroll-mt-24 md:scroll-mt-28 py-20 relative">
        <div className="container mx-auto px-4">
  ...
  <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row md:justify-between items-center gap-6">
    ...
    {/* Horário e Redes Sociais juntos (desktop) */}
